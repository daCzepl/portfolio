...
export const Home = () => {
  return (
    <div className="text-white flex h-full justify-center items-center px-12 flex-col font-aquire" id="home">
      ...
      <div className="text-xl md:text-2xl lg:text-3xl text-center mb-72 h-10">
        <WritingAnimationText delay={500}>Software Engineer & App Developer.</WritingAnimationText>
      </div>
    </div>
  );
};
